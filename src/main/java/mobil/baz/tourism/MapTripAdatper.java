...
public class MapTripAdatper extends RecyclerView.Adapter<MapTripAdatper.CountriesViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CountriesViewHolder holder, int position) {
        responsess response = mCountries.get(position);
    ...
    public static class CountriesViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindView(responsess response){

            binding.cityname.setText(response.getNameResponse());
            binding.lon.setText(String.valueOf(response.getLat()));
            binding.lat.setText(String.valueOf(response.getLon()));
        }
